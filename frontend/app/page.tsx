...
import { useHomepage, useTrackApplication } from "@/hooks/home/use-home";
        ...
        <div className="container mx-auto flex h-20 items-center justify-between px-6">
          ...
          <Link href="/" className="flex items-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-primary text-primary-foreground shadow-lg">
              <Image src={mesob} alt="Mesob" width={400} height={300} />
            </div>
        ...
        <div className="container mx-auto px-6 py-24 lg:py-32">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-muted-foreground">
              Access integrated city services, track applications, and manage
              your information securely from a single digital platform.
            </p>
            ...
            <div className="mt-20 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <CardContent className="flex items-center gap-4 p-5">
                  ...
                  <div className="text-left">
                    <p className="text-2xl font-bold">
                      {data?.data?.statistics?.total_services || 0}
                    </p>
              ...
              <Card className="border-border bg-card/80 shadow-sm backdrop-blur">
                <CardContent className="flex items-center gap-4 p-5">
                  ...
                  <div className="text-left">
                    <p className="text-2xl font-bold">
                      {data?.data?.statistics?.total_officers || 0}
                    </p>
              ...
              <Card className="border-border bg-card/80 shadow-sm backdrop-blur">
                <CardContent className="flex items-center gap-4 p-5">
                  ...
                  <div className="text-left">
                    <p className="text-2xl font-bold">
                      {data?.data?.statistics?.processed_applications || 0}
                    </p>
        ...
        <div className="container mx-auto px-6">
          <div className="mb-14 text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
              Access integrated government services digitally anytime and
              anywhere.
            </p>
          </div>

          <div className="grid gap-1 md:grid-cols-2 lg:grid-cols-3">
  {data?.data?.featured_services?.map((service) => (
    <Card
      key={service.id}
      className="group bg-card transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
    >
      <CardContent className="p-4">
        {/* IMAGE */}
        <div className="bg-primary/10 flex h-14 w-14 items-center justify-center overflow-hidden rounded-2xl">
          <Image
            src={mesob}
            alt="Mesob"
            width={100}
      ...
      <section className="border-t border-border bg-muted/30 py-20">
        <div className="container mx-auto px-6 text-center">
          <div className="mx-auto max-w-2xl">
            ...
            <h2 className="text-3xl font-bold">Leave Your Feedback</h2>

            <p className="mt-4 text-muted-foreground">
              Help us improve our services by sharing your feedback or reporting
              issues.
            </p>
          ...
          <div className="grid gap-10 md:grid-cols-4">
            ...
            <div className="col-span-2">
              <Link href="/" className="flex items-center gap-3">
                ...
                <span className="font-bold">MESOB Adama</span>
              </Link>
